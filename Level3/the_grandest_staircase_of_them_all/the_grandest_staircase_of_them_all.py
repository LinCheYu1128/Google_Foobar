"""solution 1 :run time exceed""" 
def solution(n):
    
    dic = [[0 for i in range(n+2)] for i in range(n+2)]
    def find(max, n):
        if n <= 2:
            return 1
        else:
            ...
            if dic[max][n] != 0:
                ...
                for i in range(min(n,max-1), 1, -1):
                    if (i-1)*i/2 < n-i:
                        break
                    else:
                        total +=  find(i, n-i)
...
# ans = solution(3)
# print 'ans =', ans, ', expect =', 1 == ans
# ans = solution(4)
# print 'ans =', ans, ', expect =', 1 == ans
# ans = solution(5)
# print 'answer =', ans, ', expect =', 2 == ans
# ans = solution(6)
# print 'answer =', ans, ', expect =', 3 == ans
# ans = solution(7)
# print 'answer =', ans, ', expect =', 4 == ans
# ans = solution(8)
# print 'answer =', ans, ', expect =', 5 == ans
# ans = solution(10)
# print 'answer =', ans, ', expect =', 9 == ans
# ans = solution(12)
# print 'answer =', ans, ', expect =', 14 == ans
# ans = solution(15)
# print 'answer =', ans, ', expect =', 26 == ans
# ans = solution(100)
# print 'answer =', ans, ', expect =', 444792 == ans

# import time
# start = time.time()
# ans = solution(150)
# end = time.time()
# print 'ans =', ans, ', expect =', 19406015 == ans, ', time = %f'%(end - start)

import time
start = time.time()
ans = solution(200)
end = time.time()
print 'ans =', ans, ', expect =', 487067745 == ans, ', time = %f'%(end - start)
